...
type EnvironmentSpecification struct {
	...
	NetsimArgs    *string                `protobuf:"bytes,7,opt,name=netsim_args,json=netsimArgs,proto3,oneof" json:"netsim_args,omitempty"`
...
type EnvironmentOptions struct {
	...
	NetsimArgs    *string                `protobuf:"bytes,6,opt,name=netsim_args,json=netsimArgs,proto3,oneof" json:"netsim_args,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
